...
func GetAllSelfKeypair(ctx context.Context, page, pagesize int64, order string) (results []*model.SelfKeypair, totalRows int, err error) {
...
// error - ErrNotFound, db Find error
func GetSelfKeypair(ctx context.Context, argId uint32) (record *model.SelfKeypair, err error) {
