...
JSON Sample
-------------------------------------
{    "reason": 92,    "expiry": "2286-06-20T23:57:01.802309193+08:00",    "pem": "NIarUyeMyuQCDtUVoaLYWXctc",    "not_before": "2277-09-13T05:59:41.211347736+08:00",    "sans": "FhywGSuCylQTTWJcEXEwgjEqb",    "serial_number": "OcunCCFpLqmKkOheulgeVYnqj",    "authority_key_identifier": "JypnksToEYXOYcoAiRfBoAYrf",    "ca_label": "pVfRwEQusPsFVZCUgjUGhcgIt",    "common_name": "aoSbySXychvtlTtREsJimCBib",    "metadata": "FmTeDWLnbpvZKCrkRnhraDMhm",    "status": "ViTBMuKSQfqvLDlZOHITIYABu",    "revoked_at": "2094-12-13T11:08:25.06039924+08:00",    "issued_at": "2036-08-08T14:53:33.984450504+08:00"}
...
func (c *Certificates) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (c *Certificates) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (c *Certificates) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (c *Certificates) TableInfo() *TableInfo {
	return certificatesTableInfo
}
