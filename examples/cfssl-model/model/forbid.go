...
type Forbid struct {
	...
	DeletedAt time.Time `gorm:"column:deleted_at;type:timestamp;" json:"deleted_at" db:"deleted_at"`
}
...
func (f *Forbid) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (f *Forbid) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (f *Forbid) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (f *Forbid) TableInfo() *TableInfo {
	return forbidTableInfo
}
